 ...
 * {@link Nastaveni.OnFragmentInteractionListener} interface
...
public class Nastaveni extends Fragment {
     ...
     * @return A new instance of fragment Nastaveni.
     */
...
/*
        ...
        View rootView = inflater.inflate(R.layout.fragment_nastaveni, container, false);

        Bundle bundle = getArguments();
//        String firstName = bundle.getString("FirstName");
//        String lastName = bundle.getString("LastName");

//        Bitmap bitmap = bundle.getString("fotka");
        Bitmap bitmap = bundle.getParcelable("fotka");
...
//        ImageView imageView = (ImageView) rootView.findViewById(R.id.imageView2);
        FrameLayout imageView = (FrameLayout) rootView.findViewById(R.id.flcontent);
