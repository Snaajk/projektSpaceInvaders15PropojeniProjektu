...
public class Stara__Invader {
    ...
    public Stara__Invader(Context context, int row, int column, int screenX, int screenY) {
        rect = new RectF();
        length = screenX / 20;
        height = screenY / 20;
        isVisible = true;
    ...
    private void poklesLodiNize(){
//        y = y + height;
    }

    private void zrychleniLodi(){
//        shipSpeed = shipSpeed * 1.18f;
    }


    public boolean takeAim(float playerShipX, float playerShipLength){          // zamireni nepratelske lodi pro strelbu
        int randomNumber = -1;
